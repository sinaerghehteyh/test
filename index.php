			...
			<div class="gtco-container">
				<div class="row">
					...
					<div class="col-xs-2 text-left hidden-xs menu-2">
						<ul>
							<li class="btn-cta"><a href="vrood.html"><span>ورود</span></a></li>
							<li class="btn-cta"><a href="sabtenam.html"><span>ثبتنام</span></a></li>
						</ul>
					</div>
				</div>
			</div>
					...
					<div class="col-md-8 col-md-offset-2 text-center">
						<div class="display-t">
							<div class="display-tc animate-box" data-animate-effect="fadeIn">
								<h1>Oxygen</h1>
<h2> </a><br> رایگان هرچی ک میخوای رو اگهی کن</h2>
								<p><a href="vrood.html" class="btn btn-default"> ایجاد اگهی</a></p>
							</div>
						</div>
					</div>
				</div>
	...
	<img  src="<?php print_r( $postt[2]);   ?>  " class="col-md-4 col-sm-4"   alt="user">

	<h2>  <?php  print_r( $_POST['id']= $postt[1]);   ?>  </h2>
				...
				<div class="row">
					<div class="col-md-4 col-sm-4">
						<div class="feature-center animate-box" data-animate-effect="fadeIn">
							...
							<img src="pics/person_1.jpg" alt="user">
				...
				<div class="row animate-box">
					<div class="owl-carousel owl-carousel-fullwidth ">
						...
						<div class="item">
							<div class="testimony-slide active text-center">
								<figure>
									<img src="pics/person_2.jpg" alt="user">
								</figure>
								<span><a href="#" class="twitter">Twitter</a> نام و نام خانوادگی, توسط </span>
								<blockquote>
									<p>لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است.</p>
						...
						<div class="item">
							<div class="testimony-slide active text-center">
								<figure>
									<img src="pics/person_3.jpg" alt="user">
								</figure>
								<span><a href="#" class="twitter">Twitter</a> نام و نام خانوادگی, توسط </span>
								<blockquote>
									<p>لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است.</p>
