					...
					<div class="col-md-8 col-md-offset-2 text-center">
						<div class="display-t">
							<div class="display-tc animate-box" data-animate-effect="fadeIn">
								<h1>Oxygen</h1>
	<h2> <a href="http://webrubik.com/" target="_blank"> </a><br>داشبورد ادمین</h2>
		...
		<div id="gtco-features">
			<div class="gtco-container">
				<div class="row">
					...
					<?php foreach($posts as $postt) { if($postt[5]==0){  ?>
...
<p><a href="tt.php/?id=<?php print_r($postt[0]);?>&req=ss" class="btn btn-primary">  تایید کردن  </a></p>
<p><a href="tt.php/?id=<?php print_r($postt[0]);?>/&req=de" class="btn btn-danger">  رد کردن </a></p>
